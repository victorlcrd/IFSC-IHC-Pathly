        ...
        <aside className="dashboard-sidebar">
          ...
          <nav className="sidebar-nav">
            {[
              ...
              <a key={i} href="#" className={`sidebar-item${i === 0 ? ' sidebar-item-active' : ''}`}>
                {item.icon}
                {item.label}
              </a>
            ))}
        ...
        <main className="dashboard-content">
          ...
          <div className="dashboard-greeting-wrap">
            <div>
              ...
              <p className="dashboard-greeting-sub">Você tem {trilhasAtivas} trilhas ativas e {totalAlunos} alunos aprendendo agora.</p>
            </div>
          </div>
          ...
          <section className="dashboard-section" id="trilhas">
            ...
            <div className="table-wrapper">
              <table className="trilhas-table">
                <thead>
                  <tr><th>Trilha</th><th>Status</th><th>Alunos</th><th>Conclusões</th></tr>
                </thead>
                <tbody>
                  {TRILHAS.map((t, i) => (
                    <tr key={i}>
...
function IconSettings() {
  return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/></svg>
}
