...
export function AprendizSidebar({ active, onOpenDashboard, onOpenMinhasTrilhas }: AprendizSidebarProps) {
  return (
    <aside className="dashboard-sidebar">
      ...
      <nav className="sidebar-nav" aria-label="Menu do aprendiz">
        ...
        <button type="button" className={`sidebar-item sidebar-button sidebar-nav-button${active === 'conquistas' ? ' sidebar-item-active' : ''}`}>
          <IconTrophy />
          Conquistas
        </button>
        ...
        <button type="button" className={`sidebar-item sidebar-button sidebar-nav-button${active === 'perfil' ? ' sidebar-item-active' : ''}`}>
          <IconUser />
          Perfil
        </button>
      </nav>
